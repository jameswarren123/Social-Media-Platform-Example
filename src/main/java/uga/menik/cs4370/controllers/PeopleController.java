...
public class PeopleController {
    ...
    public ModelAndView webpage(@RequestParam(name = "error", required = false) String error) {
        ...
        try {
            List<FollowableUser> followableUsers = peopleService
                    .getFollowableUsers(userService.getLoggedInUser().getUserId());
    ...
    public String followUnfollowUser(@PathVariable("userId") String userId,
        ...
        try {
            ...
            peopleService.updateFollowStatus(loggedInUserId, userId, isFollow);
        } catch (SQLException e) {
            return "redirect:/people?error=Could not update follow status.";
        }
        ...
        // String message = URLEncoder.encode("Failed to (un)follow the user. Please try
        // again.",
